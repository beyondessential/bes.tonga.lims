...
from bes.tonga.lims import PROFILE_ID
from bes.tonga.lims.config import ACTIONS_TO_HIDE
from bes.tonga.lims.config import ID_FORMATTING
from bes.tonga.lims.config import IMPRESS_SETTINGS
from bes.tonga.lims.config import LABORATORY_SETTINGS
from bes.tonga.lims.config import LANG_SETTINGS
from bes.tonga.lims.config import PATIENT_SETTINGS
from bes.tonga.lims.config import REJECTION_REASONS
from bes.tonga.lims.config import SAMPLE_ADD_FIELDS_TO_HIDE
from bes.tonga.lims.config import SAMPLE_FIELDS_ORDER
from bes.tonga.lims.config import SETUP_SETTINGS
...
BEHAVIORS = [
    ("ContainerType", [
        "bes.tonga.lims.behaviors.containertype.IExtendedContainerTypeBehavior", # noqa
    ]),
    ("SampleContainer", [
        "bes.tonga.lims.behaviors.samplecontainer.IExtendedSampleContainerBehavior",  # noqa
    ]),
    ("SampleTemplate", [
        "bes.tonga.lims.behaviors.sampletemplate.IExtendedSampleTemplateBehavior", # noqa
    ]),
]
...
def setup_handler(context):
    ...
    """
    if context.readDataFile('bes.tonga.lims.txt') is None:
        return
