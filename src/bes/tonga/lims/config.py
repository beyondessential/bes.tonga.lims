...
SETUP_SETTINGS = [
    ...
    ("AutoStickerTemplate", "bes.tonga.lims.stickers:Code_39_40x20mm"),
    ("SmallStickerTemplate", "bes.tonga.lims.stickers:QR_1x14mmx39mm"),
    ("LargeStickerTemplate", "bes.tonga.lims.stickers:Code_39_40x20mm"),
]
...
IMPRESS_SETTINGS = [
    ("templates", ["bes.tonga.lims.impress:Default.pt", ]),
    ("default_template", "bes.tonga.lims.impress:Default.pt"),
]
