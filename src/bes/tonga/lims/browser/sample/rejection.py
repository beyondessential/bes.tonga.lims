...
from bes.tonga.lims.utils import get_field_value
from bes.tonga.lims.utils import get_fullname
from bes.tonga.lims.utils import to_localized_time
...
class RejectionView(BrowserView):
    ...
    def get_image_url(self, file_name):
        ...
        url = "{}/++plone++bes.tonga.lims.static/assets/images/{}"
